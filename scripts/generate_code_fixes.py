...
from src.KnowledgeDatabaseManager import KnowledgeDatabaseManager
from src.CodeFixGenerator import CodeFixGenerator
...
Examples:
  ...
  python scripts/generate_code_fixes.py Mka
  
  # Generate fixes with AI-only mode
  python scripts/generate_code_fixes.py Mka --ai-mode ai_only
  
  # Generate fixes for specific violations
  python scripts/generate_code_fixes.py Mka --violations CERT_C-STR31-a MISRAC2012-RULE_8_7-a
  
  # Generate fixes using only rules (no AI)
  python scripts/generate_code_fixes.py Mka --ai-mode rules_only
